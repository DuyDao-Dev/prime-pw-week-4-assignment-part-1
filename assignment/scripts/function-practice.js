...
console.log(multiplyThree(3, 5, 5));

// 5. Function that will return true if a number is positive,
//    or greater than zero, and false otherwise
function isPositive( number ) {
  if ( number > 0 ){
    return true;//I entered true
  }
    return false;//I entered false
}
...
console.log(find(100, [1, 3, 5, 7, 9]));
console.log(find(9, [1, 3, 5, 7, 9]));//Test to see if it would be true. It is.
